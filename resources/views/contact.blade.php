...
<nav class="relative primary-color after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            ...
            <a href="homepage" aria-current="page" class="rounded-md px-3 py-2 text-sm text-gray-300 hover:bg-white/5 font-medium hover:text-white">Homepage</a>
            ...
            <a href="contact" class="rounded-md px-3 py-2 text-sm bg-gray-950/50 font-medium text-gray-300 text-white">Contact</a>
          </div>
        </div>
      </div>
  ...
  <el-disclosure id="mobile-menu" hidden class="block sm:hidden">
    <div class="space-y-1 px-2 pt-2 pb-3">
      <!-- Current: "bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
      <a href="homepage" aria-current="page" class="block rounded-md px-3 py-2 text-gray-300 hover:bg-white/5 text-base font-medium hover:text-white">Homepage</a>
      ...
      <a href="contact" class="block rounded-md px-3 py-2 bg-gray-950/50 text-base font-medium text-gray-300 text-white">Contact</a>
    </div>
  </el-disclosure>
</nav>
